...
export default class KeyStoreView extends Component {
  ...
  save() {
    Keychain
      .setGenericPassword(this.state.username, this.state.password, this.state.service)
      .then(() => {
  ...
  load() {
    Keychain
      .getGenericPassword(this._service)
      .then((credentials) => {
        if (credentials) {
        ...
        <View style={styles.content}>
          ...
          <View style={styles.field}>
            ...
            <TextInput
                ...
                onChange={(event) => this.setState({ service: event.nativeEvent.text })}
            />
        </View>
